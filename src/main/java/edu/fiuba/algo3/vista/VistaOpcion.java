...
public class VistaOpcion extends Button {
    ...
    public VistaOpcion(Stage stage, Opcion unaOpcion, PreguntaVF unaPregunta, Jugador unJugador, VistaPanel vPanel, Panel panel){
        this.opcion=unaOpcion;
        this.jugador=unJugador;
        this.pregunta=unaPregunta;
        this.setText(this.opcion.texto());
        this.setStyle("-fx-font-size: 20px");
        AsignarRespuestaVFEventHandler accion = new AsignarRespuestaVFEventHandler(stage,this.jugador,this.pregunta,this.opcion,vPanel,panel);
