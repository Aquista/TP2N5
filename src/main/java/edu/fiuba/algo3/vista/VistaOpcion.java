...
public class VistaOpcion extends Button {
    ...
    public VistaOpcion(Opcion unaOpcion, PreguntaVF unaPregunta, Jugador unJugador){
        this.opcion=unaOpcion;
        this.jugador=unJugador;
        this.pregunta=unaPregunta;
        this.setText(this.opcion.texto());
        this.setStyle("-fx-font-size: 20px");
        AsignarRespuestaVFEventHandler accion = new AsignarRespuestaVFEventHandler(this.jugador,this.pregunta,this.opcion);
